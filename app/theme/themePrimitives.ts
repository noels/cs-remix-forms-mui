...
declare module '@mui/material/styles' {
  ...
  interface TypographyVariants {
    logoName: React.CSSProperties;
    logoStrap: React.CSSProperties;
    pageCardBreadcrumb: React.CSSProperties;
  }
...
const { breakpoints, typography: { pxToRem } } = customTheme
...
export const getDesignTokens = (mode: PaletteMode) => ({
  palette: {
    ...
    secondary: {
      light: brandSecondary[200],
      main: brandSecondary[400],
      dark: brandSecondary[700],
      contrastText: brandSecondary[50],
      ...(mode === 'dark' && {
        contrastText: brandSecondary[50],
    ...
    background: {
      default: '#ffffff',
      paper: gray[50],
      ...(mode === 'dark' && { default: gray[800], paper: gray[900] }),
    },
    text: {
      primary: gray[800],
      secondary: gray[600],
      warning: orange[400],
      ...(mode === 'dark' && { primary: gray[100], secondary: gray[400] }),
    },
    action: {
